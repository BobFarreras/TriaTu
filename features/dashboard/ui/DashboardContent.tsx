...
export function DashboardContent({ userName, userId, userRooms }: Props) {
    ...
    return (
        // 1. FONS: Eliminem lògica light. Forcem fons fosc si falla el patró.
        <main className="min-h-dvh w-full p-4 md:p-6 flex flex-col relative bg-[#131f24] bg-gamified-pattern selection:bg-purple-500 selection:text-white overflow-y-auto md:overflow-hidden">
            ...
            {/* DECORACIÓ DE FONS (Sempre fosca) */}
            ...
            <div className="flex-1 flex flex-col justify-start lg:justify-center min-h-0 w-full max-w-6xl mx-auto pb-24 lg:pb-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 w-full items-start">
                    ...
                    <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-4 animate-in slide-in-from-left-4 duration-700">
                        ...
                        {/* TARGETA PRINCIPAL: Fosc (bg-zinc-900/90) */}
                        <div className="bg-zinc-900/90 backdrop-blur-xl rounded-[2.5rem] border-4 border-zinc-800 shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="p-6 md:p-8 relative z-10">
                                 <div className="mb-6 flex items-center gap-3 opacity-80">
                                    {/* ICONA: Fons lila fosc */}
                                    <div className="w-8 h-8 bg-purple-900/50 text-purple-400 rounded-lg flex items-center justify-center animate-pulse">⚡</div>
                                    <span className="font-black text-sm uppercase tracking-wide text-gray-400">Mode Ràpid</span>
                                 </div>
                    ...
                    <div className="lg:col-span-5 xl:col-span-4 flex flex-col gap-4 animate-in slide-in-from-right-4 duration-700 delay-100">
                        ...
                        {/* BOTÓ CREATE ROOM (Mantenim color blau vibrant) */}
                        <Link href="/rooms/create" className="group relative w-full h-28 md:h-32 bg-blue-600 hover:bg-blue-500 rounded-4xl border-b-[6px] border-blue-800 active:border-b-0 active:translate-y-1.5 active:mt-1.5 transition-all overflow-hidden shadow-xl shadow-blue-900/20 flex items-center px-6 justify-between">
                        ...
                        {/* BOTÓ JOIN ROOM (Mantenim color taronja vibrant) */}
                        <Link href="/join" className="group relative w-full h-28 md:h-32 bg-orange-500 hover:bg-orange-400 rounded-4xl border-b-[6px] border-orange-700 active:border-b-0 active:translate-y-1.5 active:mt-1.5 transition-all overflow-hidden shadow-xl shadow-orange-900/20 flex items-center px-6 justify-between">
                            <div className="z-10 flex flex-col">
                        ...
                        {/* BOTÓ PERFIL: Fosc (bg-zinc-800) */}
                        <Link href="/profile" className="group w-full h-20 bg-zinc-800 rounded-[1.8rem] border-2 border-zinc-700 hover:border-purple-500 hover:shadow-lg transition-all flex items-center px-6 justify-between mt-2">

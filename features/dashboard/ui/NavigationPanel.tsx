...
export function NavigationPanel() {
 ...
 return (
    ...
    <div className="flex flex-col gap-3 h-full animate-in slide-in-from-right-4 duration-700 delay-100 pb-1">
      ...
      <Link href="/community" className={`${cardBaseClass} bg-pink-600 hover:bg-pink-500 border-pink-800 shadow-pink-900/20`}>
        <div className="z-10 flex flex-col justify-center">
      ...
      <Link href="/community/ranking" className={`${cardBaseClass} bg-amber-500 hover:bg-amber-400 border-amber-700 shadow-amber-900/20`}>
        <div className="z-10 flex flex-col justify-center">

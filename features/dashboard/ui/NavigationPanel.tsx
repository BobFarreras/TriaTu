    ...
    <div className="flex flex-col gap-3 h-full animate-in slide-in-from-right-4 duration-700 delay-100 pb-1">
      ...
      <Link href="/rooms/create" className={`${cardBaseClass} bg-blue-600 hover:bg-blue-500 border-blue-800 shadow-blue-900/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-blue-200 bg-blue-800/30 px-2 py-0.5 rounded w-fit mb-0.5">
            {t.dashboard.nav.multiplayer_badge}
          </span>
      ...
      <Link href="/join" className={`${cardBaseClass} bg-orange-500 hover:bg-orange-400 border-orange-700 shadow-orange-900/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-orange-100 bg-orange-700/30 px-2 py-0.5 rounded w-fit mb-0.5">
             {t.dashboard.nav.guest_badge}
          </span>
      ...
      <Link href="/recipes" className={`${cardBaseClass} bg-pink-600 hover:bg-pink-500 border-pink-800 shadow-pink-900/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-pink-100 bg-pink-800/40 px-2 py-0.5 rounded w-fit mb-0.5 tracking-wider uppercase">
            {t.dashboard.nav.recipes_badge}
          </span>
      ...
      <Link href="/ranking" className={`${cardBaseClass} bg-amber-500 hover:bg-amber-400 border-amber-700 shadow-amber-900/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-amber-100 bg-amber-700/40 px-2 py-0.5 rounded w-fit mb-0.5 tracking-wider uppercase">
            {t.dashboard.nav.ranking_badge}
          </span>
          <h3 className="text-lg md:text-xl font-black text-white leading-none tracking-tight">
      ...
      <Link href="/rooms" className={`${cardBaseClass} bg-indigo-600 hover:bg-indigo-500 border-indigo-800 shadow-indigo-900/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-indigo-100 bg-indigo-800/40 px-2 py-0.5 rounded w-fit mb-0.5 tracking-wider uppercase">
             {t.dashboard.nav.my_rooms_badge}
          </span>
          <h3 className="text-lg md:text-xl font-black text-white leading-none tracking-tight">
             {t.dashboard.nav.my_rooms}
          </h3>
        </div>
        <span className="text-3xl md:text-5xl filter drop-shadow-lg group-hover:scale-110 group-hover:-rotate-6 transition-transform duration-300">🏘️</span>
      </Link>
      ...
      <Link href="/inventory" className={`${cardBaseClass} bg-emerald-600 hover:bg-emerald-500 border-emerald-800 shadow-emerald-900/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-emerald-100 bg-emerald-800/40 px-2 py-0.5 rounded w-fit mb-0.5 tracking-wider uppercase">
             {t.dashboard.nav.inventory_badge}
          </span>
          <h3 className="text-lg md:text-xl font-black text-white leading-none tracking-tight">
      ...
      <Link href="/profile" className={`${cardBaseClass} bg-zinc-700 hover:bg-zinc-600 border-zinc-900 shadow-black/20`}>
        <div className="z-10 flex flex-col justify-center">
          <span className="text-[9px] font-black text-zinc-300 bg-zinc-900/40 px-2 py-0.5 rounded w-fit mb-0.5 tracking-wider uppercase">
             {t.dashboard.nav.profile_badge}
          </span>
          <h3 className="text-lg md:text-xl font-black text-white leading-none tracking-tight">

// src/features/profile/ui/ProfileContent.tsx
'use client';
      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur-md border-b border-white/5 bg-[#131f24]/80">
         <div className="max-w-5xl mx-auto p-4 md:p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
                <Link 
                    href="/dashboard" 
                    className="group flex items-center justify-center w-12 h-12 bg-zinc-900/80 rounded-2xl border-2 border-zinc-700 hover:border-white transition-all shadow-sm"
                >

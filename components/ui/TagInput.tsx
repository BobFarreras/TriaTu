      ...
      <div className="relative flex gap-2">
        <div className="relative flex-1">
            <input
                ...
                className="
                    w-full pl-4 pr-4 py-4 rounded-2xl 
                    border-2 border-orange-900/50 
                    bg-black/40 
                    focus:border-orange-500 focus:ring-4 focus:ring-orange-900/30 
      ...
      <div className="flex flex-wrap gap-3 min-h-12">
        {tags.length > 0 ? (
            ...
            <span 
                key={idx} 
                className="
                    animate-in zoom-in duration-200 group relative inline-flex items-center gap-2 px-4 py-2 
                    bg-orange-900/40 
                    text-orange-200 
                    font-black rounded-xl 
                    border-2 border-orange-800 
                    select-none transform hover:scale-105 transition-transform
                "
            >
                ...
                className="bg-black/20 hover:bg-black/40 text-orange-200 rounded-full p-0.5 transition-colors"
                >
            ...
            <p className="text-sm text-gray-500 italic w-full text-center py-2 opacity-60">

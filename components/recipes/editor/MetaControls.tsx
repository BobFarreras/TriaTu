        ...
        <div className="shrink-0 z-50 relative">
            ...
            <div className="relative flex flex-col p-4 gap-4">
                ...
                <div className="flex items-start gap-3">
                    ...
                    <textarea
                        id="tour-recipe-title" // 👈 AFEGEIX AIXÒ
                        ref={textareaRef}
                        rows={1}
                        value={data.name}
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 pl-1">
                    ...
                    <div className="flex items-center gap-1 bg-slate-900/50 p-1.5 rounded-xl border border-slate-800 self-start">
                        <div id="tour-prep-time" className="px-2 flex items-center gap-1.5 text-slate-400 border-r border-slate-800 mr-1">
                    ...
                    <div id="tour-dietary-tags" className=" flex gap-2 overflow-x-auto no-scrollbar mask-linear-fade-right w-full sm:w-auto pb-1">
                        {TAGS.map(tag => {

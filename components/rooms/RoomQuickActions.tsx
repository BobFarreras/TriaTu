    ...
    <div className="grid grid-cols-2 gap-4 mb-8">
      ...
      >
        <div className="z-10 flex flex-col items-start">
            <span className="text-[9px] font-black text-blue-200 bg-blue-800/30 px-1.5 py-0.5 rounded mb-1 tracking-wider">NOVA</span>
            <h3 className="text-sm md:text-base font-black text-white leading-none tracking-tight">Crear Sala</h3>
        </div>
      ...
      >
        <div className="z-10 flex flex-col items-start">
            <span className="text-[9px] font-black text-orange-100 bg-orange-700/30 px-1.5 py-0.5 rounded mb-1 tracking-wider">GUEST</span>
            <h3 className="text-sm md:text-base font-black text-white leading-none tracking-tight">Unir-me</h3>
        </div>

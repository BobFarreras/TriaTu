export const ca = {
  common: {
    ...
    empty_results: 'Res per aquí...',
    scope_personal: 'Personal',
    scope_shared: 'Sales Compartides'
  },
  dashboard: {
    nav: {
  ...
  taxonomy: {
    categories: {
      ...
      dairy: 'Làctics i Ous',
      dietary: 'Dietes i Bio',
      drinks: 'Begudes',
      fish: 'Peixateria',
      frozen: 'Congelats',
      fruit: 'Fruita',
      household: 'Llar i Higiene',
      meat: 'Carnisseria',
      pantry: 'Rebost',
      vegetables: 'Verdura'
    },
    subcategories: {
      charcuterie: 'Xarcuteria',
      ham_sweet: 'Pernil Dolç',
      turkey_breast: "Pit Gall D'indi",
      serrano: 'Pernil Salat',
      fuet: 'Fuet/Llonganissa',
      chorizo: 'Xoriço',
      frankfurt: 'Frankfurt',
      pate: 'Paté',
      dairy: 'Làctics i Ous',
      milk_whole: 'Llet Sencera',
      milk_semi: 'Llet Semi',
      milk_veg: 'Beguda Vegetal',
      yogurt: 'Iogurt Natural',
      yogurt_flav: 'Iogurt Sabors',
      dessert: 'Postres',
      cheese_fresh: 'Formatge Fresc',
      cheese_sliced: 'Formatge Talls',
      cheese_cured: 'Formatge Curat',
      cheese_grated: 'Formatge Ratllat',
      eggs: 'Ous',
      butter: 'Mantega',
      cream: 'Nata Cuina',
      dietary: 'Dietes i Bio',
      ...
      pizza: 'Pizza',
      veggies: 'Verdura',
      chips: 'Patates Fregir',
      croquettes: 'Croquetes',
      icecream: 'Gelats',
      meals: 'Plats Preparats',
      fruit: 'Fruita',
      banana: 'Plàtan',
      apple: 'Pomes',
      pear: 'Peres',
      ...
      lemon: 'Llimona/Llima',
      strawberry: 'Maduixes',
      cherry: 'Cireres/Picotes',
      berries: 'Fruits del Bosc',
      avocado: 'Alvocat',
      kiwi: 'Kiwi',
      mango: 'Mango',
      pineapple: 'Pinya',
      ...
      melon: 'Meló',
      watermelon: 'Síndria',
      peach: 'Préssec/Nectarina',
      grape: 'Raïm',
      pomegranate: 'Magrana',
      household: 'Llar i Higiene',
      detergent: 'Detergent Roba',
      softener: 'Suavitzant',
      dishwasher: 'Rentavaixelles',
      cleaning: 'Netejadors',
      paper: 'Paper WC/Cuina',
      shower: 'Gel/Xampú',
      dental: 'Dental',
      deo: 'Desodorant',
      baby_food: 'Menjar Nadó',
      diapers: 'Bolquers',
      cat: 'Gats',
      dog: 'Gossos',
      meat: 'Carnisseria',
      chicken_breast: 'Pit de Pollastre',
      chicken_thigh: 'Cuixes',
      chicken_wings: 'Aletes',
      chicken_whole: 'Pollastre Sencer',
      breaded: 'Arrebossats/Nuggets',
      beef_steak: 'Bistec/Entrecot',
      beef_stew: 'Vedella Estofar',
      pork_loin: 'Llom',
      pork_ribs: 'Costelles',
      sausages: 'Botifarres/Salsitxes',
      minced_meat: 'Carn Picada',
      burgers: 'Hamburgueses',
      lamb: 'Xai',
      rabbit: 'Conill',
      pantry: 'Rebost',
      oil: 'Oli Oliva',
      sunflower: 'Oli Gira-sol',
      pasta: 'Pasta',
      rice: 'Arròs',
      legumes: 'Llegums',
      sauce: 'Tomàquet/Salses',
      bread: 'Pa',
      sliced_bread: 'Pa Motlle',
      cookies: 'Galetes',
      cereals: 'Cereals',
      coffee: 'Cafè',
      cocoa: 'Cacau',
      ...
      lettuce: 'Enciam',
      tomato: 'Tomàquet',
      tomato_cherry: 'Cherry',
      cucumber: 'Cogombre',
      zucchini: 'Carbassó',
      eggplant: 'Albergínia',
      pepper_red: 'Pebrot Vermell',
      pepper_green: 'Pebrot Verd/Italià',
      mushrooms: 'Bolets',
      spinach: 'Espinacs',
      pumpkin: 'Carbassa'
    }
  ...
  recipes: {
    edit_title: 'Editar Recepta',
    anonymous_author: 'Xef Anònim'
  },
  ranking: {
    top_label: 'TOP',
  ...
  inventory: {
    ...
    explorer_title: 'Què afegim? 😋',
    explorer_subtitle: 'Tria una secció per començar',
    explorer_search_placeholder: '🔎 Què afegim avui?',
    list: {
      empty_title: "👻",
  ...
  create_recipe: {
    ...
    editor: {
      ...
      btn_cooking: 'CUINANT...',
      title_new: 'Nova Recepta',
      title_edit: 'Editant Recepta',
      delete_title: 'Eliminar recepta',
      confirm_exit: 'Vols sortir sense guardar els canvis?',
      confirm_delete: "Estàs segur que vols eliminar aquesta recepta? Aquesta acció no es pot desfer."
    },
    toasts: {
  ...
  shoppingList: {
    page_title: 'Compra Activa',
    tabs_active: 'Llista',
    tabs_history: 'Historial',
    search_label: 'Buscar productes',
    stats_total: 'Total Llista',
    stats_cart: 'Al Carret',
    loading_list: 'Carregant llista...',
    empty_list_title: 'Tot net! Afegeix coses per comprar.',
    empty_list_short: 'La llista està buida.',
    finish_button: 'Finalitzar Compra',
    finish_success_title: '🎉 Compra finalitzada!',
    finish_success_desc: 'Cost total: {total}€',
    finish_error_title: 'Error al finalitzar',
    save_error: 'Error guardant: {error}',
    history_empty: 'No tens historial de compres.',
    history_month_label: 'Mes',
    history_total_spend: 'Despesa total',
    history_view_details: 'Veure detalls',
    history_products_count: '{count} productes',
    unit_price_suffix: '€ /ut',
    personal_scope: 'Compra Personal',
    shared_scope: 'Compra Compartida',
    tour_welcome_title: 'Benvingut',
    tour_welcome_desc: 'Descripció...'
  },
  errors: {

export const es = {
  common: {
    ...
    empty_results: 'Nada por aqui...',
    scope_personal: 'Personal',
    scope_shared: 'Salas compartidas'
  },
  dashboard: {
    nav: {
  ...
  taxonomy: {
    categories: {
      ...
      dietary: 'Dietas y Bio',
      drinks: 'Bebidas',
      fish: 'Pescadería',
      frozen: 'Congelados',
      fruit: 'Fruta',
      household: 'Hogar e Higiene',
      meat: 'Carnicería',
      pantry: 'Despensa',
      vegetables: 'Verdura'
    },
    subcategories: {
      charcuterie: 'Charcutería',
      ham_sweet: 'Jamón cocido',
      turkey_breast: 'Pechuga de pavo',
      serrano: 'Jamón serrano',
      fuet: 'Fuet/Longaniza',
      chorizo: 'Chorizo',
      frankfurt: 'Frankfurt',
      pate: 'Paté',
      ...
      milk_semi: 'Leche semi',
      milk_veg: 'Bebida vegetal',
      yogurt: 'Yogur natural',
      yogurt_flav: 'Yogur sabores',
      dessert: 'Postres',
      cheese_fresh: 'Queso fresco',
      cheese_sliced: 'Queso en lonchas',
      cheese_cured: 'Queso curado',
      cheese_grated: 'Queso rallado',
      eggs: 'Huevos',
      butter: 'Mantequilla',
      ...
      pizza: 'Pizza',
      veggies: 'Verdura',
      chips: 'Patatas para freír',
      croquettes: 'Croquetas',
      icecream: 'Helados',
      meals: 'Platos preparados',
      fruit: 'Fruta',
      banana: 'Plátano',
      apple: 'Manzanas',
      pear: 'Peras',
      ...
      melon: 'Melón',
      watermelon: 'Sandía',
      peach: 'Melocotón/Nectarina',
      grape: 'Uva',
      pomegranate: 'Granada',
      household: 'Hogar e Higiene',
      detergent: 'Detergente ropa',
      softener: 'Suavizante',
      dishwasher: 'Lavavajillas',
      cleaning: 'Limpiadores',
      paper: 'Papel WC/Cocina',
      shower: 'Gel/Champú',
      dental: 'Dental',
      deo: 'Desodorante',
      baby_food: 'Comida bebé',
      diapers: 'Pañales',
      cat: 'Gatos',
      dog: 'Perros',
      meat: 'Carnicería',
      chicken_breast: 'Pechuga de pollo',
      chicken_thigh: 'Muslos',
      chicken_wings: 'Alitas',
      chicken_whole: 'Pollo entero',
      breaded: 'Empanados/Nuggets',
      beef_steak: 'Filete/Entrecot',
      beef_stew: 'Ternera para estofar',
      pork_loin: 'Lomo',
      pork_ribs: 'Costillas',
      sausages: 'Butifarras/Salchichas',
      ...
      zucchini: 'Calabacín',
      eggplant: 'Berenjena',
      pepper_red: 'Pimiento rojo',
      pepper_green: 'Pimiento verde/italiano',
      mushrooms: 'Setas',
      spinach: 'Espinacas',
      pumpkin: 'Calabaza'
    }
  ...
  inventory: {
    ...
    explorer_title: '¿Qué añadimos? 😋',
    explorer_subtitle: 'Elige una sección para empezar',
    explorer_search_placeholder: '🔎 ¿Qué añadimos hoy?',
    list: {
      empty_title: "👻",
  ...
  create_recipe: {
    ...
    editor: {
      ...
      title_new: 'Nueva Receta',
      title_edit: 'Editando Receta',
      delete_title: 'Eliminar receta',
      confirm_exit: '¿Salir sin guardar los cambios?',
      confirm_delete: '¿Seguro que quieres eliminar esta receta? Esta acción no se puede deshacer.'
    },
    toasts: {
  ...
  shoppingList: {
    ...
    stats_total: 'Total Lista',
    stats_cart: 'En el Carrito',
    loading_list: 'Cargando lista...',
    empty_list_title: '¡Todo limpio! Añade cosas para comprar.',
    empty_list_short: 'La lista está vacía.',
    finish_button: 'Finalizar Compra',
    finish_success_title: '🎉 ¡Compra finalizada!',
    finish_success_desc: 'Coste total: {total}€',
    finish_error_title: 'Error al finalizar',
    save_error: 'Error al guardar: {error}',
    history_empty: 'No tienes historial de compras.',
    history_month_label: 'Mes',
    history_total_spend: 'Gasto total',
    history_view_details: 'Ver detalles',
    history_products_count: '{count} productos',
    unit_price_suffix: '€ /ud',
    personal_scope: 'Compra Personal',
    shared_scope: 'Compra Compartida',
    tour_welcome_title: 'Bienvenido',
    tour_welcome_desc: 'Descripción...'
  },
  errors: {

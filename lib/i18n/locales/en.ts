export const en = {
  common: {
    ...
    empty_results: 'Nothing here...',
    scope_personal: 'Personal',
    scope_shared: 'Shared rooms'
  },
  dashboard: {
    nav: {
  ...
  taxonomy: {
    ...
    subcategories: {
      ...
      milk_semi: 'Semi-skimmed milk',
      milk_veg: 'Plant-based drink',
      yogurt: 'Natural yogurt',
      yogurt_flav: 'Flavored yogurt',
      dessert: 'Desserts',
      cheese_fresh: 'Fresh cheese',
      cheese_sliced: 'Sliced cheese',
      cheese_cured: 'Cured cheese',
      cheese_grated: 'Grated cheese',
      eggs: 'Eggs',
      butter: 'Butter',
      cream: 'Cooking cream',
      dietary: 'Diets & Bio',
      ...
      cleaning: 'Cleaning',
      paper: 'Toilet/Kitchen paper',
      shower: 'Shower gel/Shampoo',
      dental: 'Dental',
      deo: 'Deodorant',
      baby_food: 'Baby food',
      diapers: 'Diapers',
      ...
      chicken_whole: 'Whole chicken',
      breaded: 'Breaded/Nuggets',
      beef_steak: 'Steak/Entrecote',
      beef_stew: 'Stew beef',
      pork_loin: 'Pork loin',
      pork_ribs: 'Pork ribs',
      sausages: 'Sausages',
      ...
      pepper_green: 'Green/Italian pepper',
      mushrooms: 'Mushrooms',
      spinach: 'Spinach',
      pumpkin: 'Pumpkin'
    }
  ...
  recipes: {
    ...
    anonymous_author: 'Anonymous Chef'
  },
  ranking: {
    top_label: 'TOP',
    title: 'Hall of Fame',
  ...
  inventory: {
    ...
    explorer_title: 'What are we adding? 😋',
    explorer_subtitle: 'Choose a section to start',
    explorer_search_placeholder: '🔎 What are we adding today?',
    list: {
      empty_title: "👻",
  ...
  create_recipe: {
    ...
    editor: {
      ...
      title_edit: 'Editing Recipe',
      delete_title: 'Delete recipe',
      confirm_exit: 'Exit without saving changes?',
      confirm_delete: 'Are you sure you want to delete this recipe? This action cannot be undone.'
    },
    toasts: {
  ...
  shoppingList: {
    page_title: 'Active Shopping',
    tabs_active: 'List',
    tabs_history: 'History',
    search_label: 'Search products',
    stats_total: 'List Total',
    stats_cart: 'In Cart',
    loading_list: 'Loading list...',
    empty_list_title: 'All clear! Add items to buy.',
    empty_list_short: 'The list is empty.',
    finish_button: 'Finish Shopping',
    finish_success_title: '🎉 Shopping complete!',
    finish_success_desc: 'Total cost: {total}€',
    finish_error_title: 'Error finishing',
    save_error: 'Error saving: {error}',
    history_empty: 'No shopping history yet.',
    history_month_label: 'Month',
    history_total_spend: 'Total spend',
    history_view_details: 'View details',
    history_products_count: '{count} items',
    unit_price_suffix: '€ /unit',
    personal_scope: 'Personal Shopping',
    shared_scope: 'Shared Shopping',
    tour_welcome_title: 'Welcome',
    tour_welcome_desc: 'Description...'
  },
  errors: {

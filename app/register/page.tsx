...
export default function RegisterPage() {
  ...
  return (
    <div className="h-[100dvh] w-full flex flex-col items-center justify-center p-4 relative overflow-hidden selection:bg-green-500 selection:text-white">
      ...
      <div className="w-full max-w-sm md:max-w-md animate-in slide-in-from-bottom-8 fade-in duration-700 relative z-10 flex flex-col justify-center">
        ...
        <div className="bg-zinc-900/70 backdrop-blur-xl rounded-[2rem] px-6 py-6 md:p-8 border-4 border-zinc-800 shadow-2xl relative overflow-hidden group">
           ...
           <div className="mt-4 md:mt-8 text-center pt-4 border-t border-zinc-800">
             <p className="text-xs md:text-sm font-bold text-gray-400">
               {t.auth.has_account}{' '}
               <Link href="/login" className="text-emerald-500 hover:text-emerald-400 transition-colors hover:underline decoration-2 underline-offset-4 decoration-wavy ml-1">
                 {t.auth.login_link}
               </Link>
             </p>
           </div>

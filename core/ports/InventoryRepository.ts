...
export interface InventoryRepository {
  ...
  // Canviem el nom per ser més genèric o ampliem l'existent
  // 'contextId' pot ser null (personal) o un roomId.
  findByContext(userId: string, roomId?: string): Promise<InventoryItem[]>;
